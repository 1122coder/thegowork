...
const Signup = () => {
  ...
  return (
    <div className='auth-form-div'>
        ...
        <button type = 'button' onClick={()=>{setShow1(!show1)}}>{show?<VisibilityIcon />    :<VisibilityOffIcon />}</button>
        </div>
        ...
        <input type='checkbox' name = 'terms' onBlur={handleBlur}
        onChange={handleChange} id = 'tandc' /><label htmlFor = 'tandc'>Agree to <Link>Terms and Conditions</Link></label>
        </div>
        <SmallButton 
        variant = 'contained'
